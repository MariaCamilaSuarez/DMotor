...
<head>
    ...
    <!-- data tables -->
	<link href="_css/Header/bootstrap/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css" rel="stylesheet"
		type="text/css" />
    <!-- morris chart -->
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-white">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- end chat sidebar -->
            <%@include file="Mechanics/Mechanics.jsp" %>
        </div>
        <!-- end page container -->
    ...
    <!-- data tables -->
	<script src="_css/Header/bootstrap/plugins/datatables/jquery.dataTables.min.js"></script>
	<script src="_css/Header/bootstrap/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js"></script>
	<script src="_js/Header/pages/table/table_data.js"></script>
    <!-- google map -->
